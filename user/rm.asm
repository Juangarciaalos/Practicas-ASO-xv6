...
main(int argc, char *argv[])
{
  ...
  35:	ff 36                	pushl  (%esi)
  37:	e8 9b 00 00 00       	call   d7 <unlink>
...
00000107 <dup2>:
SYSCALL(dup2)
 107:	b8 17 00 00 00       	mov    $0x17,%eax
 10c:	cd 40                	int    $0x40
 10e:	c3                   	ret    

0000010f <getpid>:
SYSCALL(getpid)
 10f:	b8 0b 00 00 00       	mov    $0xb,%eax
 114:	cd 40                	int    $0x40
 116:	c3                   	ret    

00000117 <sbrk>:
SYSCALL(sbrk)
 117:	b8 0c 00 00 00       	mov    $0xc,%eax
 11c:	cd 40                	int    $0x40
 11e:	c3                   	ret    

0000011f <sleep>:
SYSCALL(sleep)
 11f:	b8 0d 00 00 00       	mov    $0xd,%eax
 124:	cd 40                	int    $0x40
 126:	c3                   	ret    

00000127 <uptime>:
SYSCALL(uptime)
 127:	b8 0e 00 00 00       	mov    $0xe,%eax
 12c:	cd 40                	int    $0x40
 12e:	c3                   	ret    

0000012f <date>:
SYSCALL(date)
 12f:	b8 16 00 00 00       	mov    $0x16,%eax
 134:	cd 40                	int    $0x40
 136:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 190:	43                   	inc    %ebx
 191:	8a 92 64 03 00 00    	mov    0x364(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 2d1:	75 13                	jne    2e6 <printf+0x110>
          s = "(null)";
 2d3:	be 5d 03 00 00       	mov    $0x35d,%esi
