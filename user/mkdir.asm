...
main(int argc, char *argv[])
{
  ...
  4f:	ff 36                	push   (%esi)
  51:	e8 95 00 00 00       	call   eb <mkdir>
...
00000103 <dup2>:
 103:	b8 17 00 00 00       	mov    $0x17,%eax
 108:	cd 40                	int    $0x40
 10a:	c3                   	ret    

0000010b <getpid>:
 10b:	b8 0b 00 00 00       	mov    $0xb,%eax
 110:	cd 40                	int    $0x40
 112:	c3                   	ret    

00000113 <sbrk>:
 113:	b8 0c 00 00 00       	mov    $0xc,%eax
 118:	cd 40                	int    $0x40
 11a:	c3                   	ret    

0000011b <sleep>:
 11b:	b8 0d 00 00 00       	mov    $0xd,%eax
 120:	cd 40                	int    $0x40
 122:	c3                   	ret    

00000123 <uptime>:
 123:	b8 0e 00 00 00       	mov    $0xe,%eax
 128:	cd 40                	int    $0x40
 12a:	c3                   	ret    

0000012b <date>:
 12b:	b8 16 00 00 00       	mov    $0x16,%eax
 130:	cd 40                	int    $0x40
 132:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 17e:	43                   	inc    %ebx
 17f:	8a 92 bc 03 00 00    	mov    0x3bc(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 241:	ff 24 85 64 03 00 00 	jmp    *0x364(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 2a6:	75 13                	jne    2bb <printf+0xf5>
          s = "(null)";
 2a8:	be 5b 03 00 00       	mov    $0x35b,%esi
