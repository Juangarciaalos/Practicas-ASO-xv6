...
0000017b <dup2>:
SYSCALL(dup2)
 17b:	b8 17 00 00 00       	mov    $0x17,%eax
 180:	cd 40                	int    $0x40
 182:	c3                   	ret    

00000183 <getpid>:
SYSCALL(getpid)
 183:	b8 0b 00 00 00       	mov    $0xb,%eax
 188:	cd 40                	int    $0x40
 18a:	c3                   	ret    
...
00000193 <sleep>:
SYSCALL(sleep)
 193:	b8 0d 00 00 00       	mov    $0xd,%eax
 198:	cd 40                	int    $0x40
 19a:	c3                   	ret    

0000019b <uptime>:
SYSCALL(uptime)
 19b:	b8 0e 00 00 00       	mov    $0xe,%eax
 1a0:	cd 40                	int    $0x40
 1a2:	c3                   	ret    

000001a3 <date>:
SYSCALL(date)
 1a3:	b8 16 00 00 00       	mov    $0x16,%eax
 1a8:	cd 40                	int    $0x40
 1aa:	c3                   	ret    
